...
describe("App shell", () => {
  it("redirects /overview to the dashboards", async () => {
    // The page it used to render described this migration's own progress rather than quality
    // data. Asserting the redirect keeps the old URL working for anyone who bookmarked it.
    window.history.pushState({}, "", "/ui/overview");
    render(<App />);

    await waitFor(() => expect(window.location.pathname).toBe("/ui/dashboards"));
  });
